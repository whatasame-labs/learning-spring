...
public class AopAspect {
    ...
    @Before("execution(* com.whatasame.aop..*.doBefore())")
    public void before() {
        logger.log("before");
    }

    @Around("execution(void com.whatasame.aop.AopComponent.doAround(..))")
    ...
    @After("execution(public * com.whatasame.aop.AopComponent.doAfter())")
    public void after() {
        logger.log("after");
    }
}
